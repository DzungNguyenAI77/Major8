...
class Car:
    def __init__(self, x, y):
        ...
        self.original_image = pygame.image.load("D:/Chuyen_Nganh_8/RLE/VALIDATE_GYM/racing_car/car2.png").convert()
...
class RacingEnv:
    ...
    def __init__(self):
        ...
        self.back_image = pygame.image.load("D:/Chuyen_Nganh_8/RLE/VALIDATE_GYM/racing_car/track.png").convert()
